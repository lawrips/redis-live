...
/***/ function(module, exports, __webpack_require__) {
	...
	var RedisResults = __webpack_require__(1);
	var CommandInput = __webpack_require__(2);
	var RunButton = __webpack_require__(3);
	var ServerStatus = __webpack_require__(4);
	var ClusterStatus = __webpack_require__(6);
	...
	if (resultsTextArea && commandInput && runButton) {
	    var Output = ReactDOM.render(React.createElement(RedisResults, null), resultsTextArea);

	    var Input = ReactDOM.render(React.createElement(CommandInput, { commands: redisLive.commands }), commandInput);

	    var Run = ReactDOM.render(React.createElement(RunButton, { path: redisLive.path }), runButton);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ServerSelector = __webpack_require__(5);
